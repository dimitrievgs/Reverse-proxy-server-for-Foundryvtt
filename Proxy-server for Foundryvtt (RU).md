...
5) Позволяет использовать один сервер vps/vds нескольким ГМам.
6) Не нужно открывать TCP-порты 80 (http), 443 (https) на компьютере, на котором непосредственно развёрнут Foundryvtt
