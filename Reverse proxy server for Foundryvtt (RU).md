# Обратный прокси-сервер для Foundryvtt (ПК ГМа - Wireguard - nginx) <!-- omit in toc --> 
...
- [8. Wireguard](#8-wireguard)
  ...
  - [8.3. Генерация пар публичный - приватный ключ](#83-генерация-пар-публичный---приватный-ключ)
  - [8.4. Запись настроек в файлы конфигураций](#84-запись-настроек-в-файлы-конфигураций)
  - [8.5. Запуск интерфейсов Wireguard с нужной конфигурацией](#85-запуск-интерфейсов-wireguard-с-нужной-конфигурацией)
  - [8.6. Открытие портов на машине с Foundryvtt](#86-открытие-портов-на-машине-с-foundryvtt)
...
Для файрвола ufw действуйте по аналогии с секцией:
* [8.5. Запуск интерфейсов Wireguard с нужной конфигурацией](#85-запуск-интерфейсов-wireguard-с-нужной-конфигурацией).
